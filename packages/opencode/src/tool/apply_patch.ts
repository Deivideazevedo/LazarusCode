      ...
      for (const change of fileChanges) {
        ...
        switch (change.type) {
          case "add":
            ...
            yield* afs.writeWithDirs(
              change.filePath,
              Codepage.prepareWrite(change.newContent, change.filePath, change.bom),
            )
          ...
          case "move":
            if (change.movePath) {
              ...
              yield* afs.writeWithDirs(
                change.movePath!,
                Codepage.prepareWrite(change.newContent, change.movePath!, change.bom),
              )
